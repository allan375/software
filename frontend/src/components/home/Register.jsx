...
export default function Register(){
  ...
  return(
    <div className="sessao w-full h-full flex justify-center items-center font-nunito">
      <div className="sessao-container w-full flex flex-col items-center justify-center gap-1 py-6 px-6 rounded-2xl">
        ...
        <form action="" method="post" id='register-form' className='w-full flex flex-col items-center'>
          <div className="input-container w-full">
            ...
            <input type="text" placeholder='Digite seu nome' className='w-full py-1 px-3 text-[14.3px] rounded-lg border' />
          </div>
